...
interface WinCelebrationProps {
  ...
  accentFrom?: string
  accentTo?: string
  /** 'light' renders on a white backdrop with the accent color carrying the highlights, instead of the default dark/glow treatment */
  theme?: 'dark' | 'light'
}

export function WinCelebration({ reward, emoji = '🎁', code, hidePlayAgain, onClose, accentFrom, accentTo, theme = 'dark' }: WinCelebrationProps) {
...
export function NoWin({ onClose, accentTo, theme = 'dark' }: { onClose?: () => void; accentTo?: string; theme?: 'dark' | 'light' }) {
  const router = useRouter()
