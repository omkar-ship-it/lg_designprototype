...
interface RubLampClaimProps {
  title?: string
  subtitle?: string
  claimedTitle?: string
  claimedSubtitle?: string
  /** Extra content (e.g. claim/redeem window, terms) shown above the lamp while unclaimed */
  children?: ReactNode
  /** Called once the genie has been summoned — parent should transition to its reward screen */
  onComplete: () => void
        ...
        <div className="text-center mb-5 min-h-[60px] flex flex-col items-center justify-center">
          <AnimatePresence mode="wait">
            {claimed ? (
              ...
              >
                <p className="text-white text-[22px] font-bold leading-snug">{claimedTitle}</p>
