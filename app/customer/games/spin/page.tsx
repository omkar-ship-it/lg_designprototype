    ...
    >
      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div>
            <h2 className="text-xl font-bold text-white">🎡 Spin Fiesta</h2>
            <p className="text-xs text-white/60 mt-1">Weekend spin to win</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 text-xs">
          <div>
            ...
            <p className="text-white font-bold text-sm">55%</p>
          </div>
          <div>
            <p className="text-white/40 mb-1 uppercase tracking-wide text-[10px]">Duration</p>
            <p className="text-white font-bold text-sm">Jun 10–30</p>
          </div>
          <div>
            <p className="text-white/40 mb-1 uppercase tracking-wide text-[10px]">Players</p>
            <p className="text-white font-bold text-sm">312 joined</p>
          </div>
        </div>
      </motion.div>

      {/* Back */}
      <button onClick={() => router.back()} className="flex items-center gap-1.5 text-white/50 hover:text-white/70 transition-colors text-sm mb-6 self-start relative z-10 px-5">
