...
const BUSINESS_NAME = 'Verde Bistro'
const BUSINESS_EMOJI = '🍝'
const REWARD_LABEL = '20% Off'
const REWARD_EMOJI = '🎫'
const CLAIM_BEFORE = '2026-06-30'
const REDEEM_BEFORE = '2026-07-15'
...
export default function CouponPage() {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(145deg, #854D0E 0%, #A16207 50%, #422006 100%)' }}
    >
      {/* Ambient orbs */}
      <div className="absolute top-0 left-0 right-0 h-64 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(202,138,4,0.3) 0%, transparent 70%)' }} />
      <div className="absolute bottom-0 -left-20 w-72 h-72 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)', filter: 'blur(48px)' }} />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        <AnimatePresence mode="wait">
          ...
          >
            <p className="text-white/70 text-base font-semibold mb-1">Coupon Codes</p>
