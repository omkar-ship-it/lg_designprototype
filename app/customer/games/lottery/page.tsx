          ...
          {state !== 'received' ? (
            <motion.div key="pre" className="flex flex-col gap-6"
              ...
              <div className="text-center">
                ...
                <p className="text-[11px] text-white/40 uppercase tracking-widest font-bold mb-1">{CAMPAIGN_NAME}</p>
                <h1 className="text-2xl font-extrabold text-white mb-1">{JACKPOT_PRIZE}</h1>
                <p className="text-sm text-white/50">{BUSINESS_NAME}</p>
              </div>
              ...
              <div className="rounded-2xl p-4"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] text-white/40 uppercase tracking-wide mb-0.5">Your tickets</p>
                    <p className="text-3xl font-black text-white">{tickets}
                      <span className="text-sm font-semibold text-white/40 ml-1">entered</span>
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] text-white/40 uppercase tracking-wide mb-0.5">More visits</p>
                    <p className="text-xs font-bold text-white/60">= more tickets</p>
                  </div>
                </div>
              </div>
            ...
            <motion.div key="post" className="flex flex-col gap-5"
              ...
              <div className="text-center">
                ...
                <h2 className="text-xl font-extrabold text-white mb-0.5">You're in!</h2>
                <p className="text-sm text-white/50">Good luck on {DRAW_DATE}</p>
              </div>
